...
class cmulti_answer_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(cmulti_answer_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != cmulti_answer_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return cmulti_answer_t._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = cmulti_answer_t()
    ...
    def _get_hash_recursive(parents):
        if cmulti_answer_t in parents: return 0
    ...
    def _get_packed_fingerprint():
        if cmulti_answer_t._packed_fingerprint is None:
            cmulti_answer_t._packed_fingerprint = struct.pack(">Q", cmulti_answer_t._get_hash_recursive([]))
        return cmulti_answer_t._packed_fingerprint
